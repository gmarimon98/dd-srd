...
To fine tune maximum campaign length, assume that it takes a conversative 180 experience points for characters to stop being able to meaningfully progress, and divide 180 by your desired maximum campaign length, resulting in the average amount of experience players should receive per session. While players can technically upgrade all their available tags to 5✦, it's unlikely they will make enough rolls in between rests for it to make a difference. For longer campaigns, this may require that you lower the base experience gain from 5 experience to 2 or 3 experience. However, part of the design is to let players upgrade the tag of their choice at least every 1 to 2 sessions, so lowering base experience gain may create a less satisfying player experience.