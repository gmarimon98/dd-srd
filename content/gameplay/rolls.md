...
2. **Add Stars.** Create your die modifier (ranging from +0 to +18) by adding up the stars on your character sheet from the following sources. The total is your modifier. For example, 6✦ results in a modifier of +6.
