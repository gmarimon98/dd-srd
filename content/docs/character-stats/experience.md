...
Whenever you want during play, you can add, remove, or modify up to three conflicts on your character sheet. Conflicts represent goals, themes, and issues that your character struggles with. Example conflicts include `New to Parenthood`, `Nature vs. Nurture`, `Refusing my Destiny`, and `Fighting for Freedom`.
